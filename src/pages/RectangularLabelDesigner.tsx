...
export default function RectangularLabelDesigner() {
  const [labelData, setLabelData] = useState({
    ...
    backgroundColorCol23: 'transparent',
    font: fonts[0].value,
    fontSize: 12,
    bold: false,
    italic: false,
          ...
          <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label className="text-lg font-semibold flex items-center gap-2">
                      ...
                      Background colour (Columns 1 & 4: top 2 + last row)
                    </Label>
                    <div className="grid grid-cols-5 gap-3">
                      {backgrounds.map((bg) => (
                        <button
                          key={bg.name}
                          onClick={() => updateLabel('backgroundColorCol14TopAndBottom', bg.value)}
                          className={`w-12 h-12 rounded-lg border-2 transition-all hover:scale-110 ${
                            labelData.backgroundColorCol14TopAndBottom === bg.value
                              ? 'border-primary scale-110 ring-2 ring-primary ring-offset-2'
                              : 'border-border hover:border-primary/50'
                          } ${bg.bg}`}
                  ...
                  <div className="space-y-2">
                    <Label className="text-lg font-semibold flex items-center gap-2">
                      <Wand2 className="w-5 h-5 text-primary" />
                      Background colour (Columns 1 & 4: last rectangle)
                    </Label>
                    <div className="grid grid-cols-5 gap-3">
                      {backgrounds.map((bg) => (
                        <button
                          key={`col14-bottom-${bg.name}`}
                          onClick={() => updateLabel('backgroundColorCol14BottomRect', bg.value)}
                          className={`w-12 h-12 rounded-lg border-2 transition-all hover:scale-110 ${
                            labelData.backgroundColorCol14BottomRect === bg.value
                              ? 'border-primary scale-110 ring-2 ring-primary ring-offset-2'
                              : 'border-border hover:border-primary/50'
                          } ${bg.bg}`}
                          style={{ backgroundColor: bg.value }}
                  ...
                  <div className="space-y-2">
                    <Label className="text-lg font-semibold flex items-center gap-2">
                      <Wand2 className="w-5 h-5 text-primary" />
                      Background colour (Columns 2 & 3)
                    </Label>
                    <div className="grid grid-cols-5 gap-3">
                      {backgrounds.map((bg) => (
                        <button
                          key={`col23-${bg.name}`}
                          onClick={() => updateLabel('backgroundColorCol23', bg.value)}
                          className={`w-12 h-12 rounded-lg border-2 transition-all hover:scale-110 ${
                            labelData.backgroundColorCol23 === bg.value
                              ? 'border-primary scale-110 ring-2 ring-primary ring-offset-2'
                              : 'border-border hover:border-primary/50'
                          } ${bg.bg}`}
                          style={{ backgroundColor: bg.value }}
